...
from models.pointnet2_utils import PointNetSetAbstractionMsg, PointNetSetAbstraction, PointNetFeaturePropagation,PointResnet
...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.sa2 = PointNetSetAbstractionMsg(128, [0.4, 0.8], [64, 128], 320, [[128, 128, 256], [128, 196, 256]])
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=512 + 3,mlp=[256, 512, 1024], group_all=True)
        self.fp3 = PointNetFeaturePropagation(in_channel=512 + 1024, mlp=[256, 256])
        self.fp2 = PointNetFeaturePropagation(in_channel=320 + 256, mlp=[256, 128])
        ...
        self.PR2 = PointResnet(0.4,64,512,512,1024,512)
    ...
    def forward(self, xyz, cls_label):
        ...
        l2_xyz, l2_points = self.PR2(l2_xyz, l2_points)
        ########
