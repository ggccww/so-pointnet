...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.sa2 = PointNetSetAbstractionMsg(128, [0.4,0.8], [64, 128], 320+320, [[128, 128, 256], [128, 196, 256]])
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=1024 + 3, mlp=[256, 512, 1024], group_all=True)
        self.fp3 = PointNetFeaturePropagation(in_channel=2048, mlp=[256, 256])
        self.fp2 = PointNetFeaturePropagation(in_channel=896, mlp=[256, 128])
