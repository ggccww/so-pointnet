...
class get_model(nn.Module):
    def __init__(self,num_class,normal_channel=True):
        ...
        self.sa1 = PointNetSetAbstractionMsgAttention(512, [0.1, 0.2, 0.4], [16, 32, 128], 128,[[32, 32, 64], [64, 64, 128], [64, 96, 128]])
        ...
        self.conv_fuse = nn.Sequential(nn.Conv1d(6, 128, kernel_size=1, bias=False),
                                       nn.BatchNorm1d(128),
                                       nn.LeakyReLU(negative_slope=0.2))
        self.conv_fuse1 = nn.Sequential(nn.Conv1d(640, 128, kernel_size=1, bias=False),
                                       nn.BatchNorm1d(128),
                                       nn.LeakyReLU(negative_slope=0.2))
    ...
    def forward(self, xyz):
        ...
        if self.normal_channel:
            ...
            norm = None
        l0_points = torch.cat((xyz, norm), dim=1)
        l0_points = self.conv_fuse(l0_points)
        ...
        l0_points = self.conv_fuse1(S_points)
