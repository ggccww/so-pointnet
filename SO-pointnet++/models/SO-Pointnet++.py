...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.sa4 = PointNetSetAbstractionMsg(256, [0.2, 0.4], [64, 96], 320,[ [64, 196], [ 96, 256]])
        self.sa2 = PointNetSetAbstractionMsg(128, [0.4, 0.8], [64, 128], 452, [[128, 128, 256], [128, 196, 256]])
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=512 + 3,mlp=[256, 512, 1024], group_all=True)
        self.fp3 = PointNetFeaturePropagation(in_channel=512 + 1024, mlp=[256, 256])
        self.fp2 = PointNetFeaturePropagation(in_channel=452 + 256, mlp=[256, 128])
        ...
        self.PR2 = PointResnet(0.5, 64, 452, 452, 904, 452)
